      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            ...
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0060</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0464</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1673</td><td className="border border-slate-300 dark:border-white/15 p-1">0.3823</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-1">k</th><th className="border border-slate-300 dark:border-white/15 p-1">12</th><th className="border border-slate-300 dark:border-white/15 p-1">14</th><th className="border border-slate-300 dark:border-white/15 p-1">16</th><th className="border border-slate-300 dark:border-white/15 p-1">18</th></tr></thead>
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1931</td><td className="border border-slate-300 dark:border-white/15 p-1">0.3675</td><td className="border border-slate-300 dark:border-white/15 p-1">0.5660</td><td className="border border-slate-300 dark:border-white/15 p-1">0.7423</td></tr></tbody>
          </table>
          ...
          <p className="text-slate-700 dark:text-slate-300">Valeur exacte: 0.9108 - 0.0774 = 0.8334</p>
        </div>
      ),
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm">
            ...
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-2">P(X=k)</td><td className="border border-slate-300 dark:border-white/15 p-2">0.2637</td><td className="border border-slate-300 dark:border-white/15 p-2">0.4945</td><td className="border border-slate-300 dark:border-white/15 p-2">0.2198</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0220</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-1">k</th><th className="border border-slate-300 dark:border-white/15 p-1">7</th><th className="border border-slate-300 dark:border-white/15 p-1">14</th><th className="border border-slate-300 dark:border-white/15 p-1">18</th></tr></thead>
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0180</td><td className="border border-slate-300 dark:border-white/15 p-1">0.4657</td><td className="border border-slate-300 dark:border-white/15 p-1">0.8195</td></tr></tbody>
          </table>
          ...
          <p className="text-slate-700 dark:text-slate-300">Valeur exacte: 0.8195 - 0.1848 = 0.6347</p>
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            ...
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1516</td><td className="border border-slate-300 dark:border-white/15 p-1">0.4514</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9004</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9984</td></tr></tbody>
          </table>
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            ...
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0012</td><td className="border border-slate-300 dark:border-white/15 p-1">0.4557</td><td className="border border-slate-300 dark:border-white/15 p-1">0.5874</td><td className="border border-slate-300 dark:border-white/15 p-1">0.8030</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-1">k</th><th className="border border-slate-300 dark:border-white/15 p-1">1</th><th className="border border-slate-300 dark:border-white/15 p-1">4</th><th className="border border-slate-300 dark:border-white/15 p-1">14</th></tr></thead>
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0005</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0293</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9165</td></tr></tbody>
          </table>
