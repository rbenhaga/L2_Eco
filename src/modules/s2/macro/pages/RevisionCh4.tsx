  ...
  return (
    <main className="max-w-6xl px-6">
      ...
      <Section type="key" title="La BCE">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">BCE prête aux banques contre titres en garantie, avec rachat ultérieur. Taux REPO = (Prix rachat - Prix vente) / Prix vente</p>
      ...
      <Section type="formule" title="Courbe de Phillips">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300">Hausse de u nécessaire pour réduire π de 1 point</p>
      </Section>
      ...
      <section className="mb-16">
        <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide mb-4 px-3 py-1.5 rounded-md bg-amber-50 dark:bg-amber-950/30 text-amber-700">
        ...
        <div className="grid md:grid-cols-2 gap-2">
          {[
            ...
            <label key={i} className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 dark:border-white/10 hover:bg-slate-100/50 dark:bg-white/5 cursor-pointer">
