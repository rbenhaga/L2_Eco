...
function Exercise({ title, points, children, defaultOpen = false }: ExerciseProps) {
  ...
  return (
    <div className="border border-slate-200 dark:border-white/10 rounded-xl mb-4 overflow-hidden">
      <button
        onClick={() => setOpen(!open)}
        className="w-full flex items-center justify-between p-4 bg-slate-100/50 dark:bg-white/5 hover:bg-slate-100/80 dark:bg-white/5 transition-colors text-left"
      >
        ...
        <span className="text-sm text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-900/80 px-2 py-1 rounded">{points} pts</span>
      </button>
      {open && <div className="p-5 bg-white dark:bg-slate-900/80">{children}</div>}
    </div>
  );
}
  ...
  return (
    <div className="mb-6 last:mb-0">
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="text-slate-900 dark:text-white font-medium pt-0.5">{question}</div>
      </div>
...
function Formula({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-3 p-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 rounded-lg text-center overflow-x-auto">
      {children}
    </div>
  );
}
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 pb-12">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 mb-3">
          <FileText className="w-4 h-4" />
          <span>Correction détaillée</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4">Annales Corrigées</h1>
      ...
      {/* Tabs */}
      <div className="flex gap-2 mb-8 p-1 bg-slate-100/80 dark:bg-white/5 rounded-lg w-fit mx-auto">
        <button
          onClick={() => setActiveYear('2024')}
          className={`px-4 py-2 rounded-md font-medium transition-colors ${
            activeYear === '2024' ? 'bg-white dark:bg-slate-900/80 text-slate-900 dark:text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:text-white'
          }`}
        >
          2024-2025
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-md font-medium transition-colors ${
            activeYear === '2023' ? 'bg-white dark:bg-slate-900/80 text-slate-900 dark:text-white shadow-sm' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:text-white'
          }`}
        >
          2023-2024
        </button>
        ...
        <div>
          ...
          <Exercise title="Exercice I - QCM Théorique" points={3} defaultOpen={true}>
            <Question num="1" question="Une variable aléatoire est :">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">⚠️ Ce n'est pas une "valeur numérique" (c'est l'image qui est numérique)</p>
            </Question>
          ...
          <Exercise title="Exercice IV - VA Discrète 2D (Billetterie)" points={6}>
            ...
            <Question num="9" question="Coefficient de corrélation ρ(X,Y) = ?">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300">⚠️ Corrélation négative : si X↑ alors Y↓ (logique !)</p>
            </Question>
        ...
        <div>
          ...
          <Exercise title="Exercice IV - Loterie et Espérance" points={5}>
            ...
            <Question num="1" question="P(gagner) = ?">
              ...
              <div className="text-sm bg-white dark:bg-slate-900/80 p-3 rounded border font-mono">
                Premier tirage:<br/>
      ...
      <div className="mt-12 p-6 bg-linear-to-br from-gray-50 to-gray-100 rounded-xl border border-slate-200 dark:border-white/10">
        <div className="flex items-center gap-3 mb-4">
          <Calculator className="w-6 h-6 text-slate-800 dark:text-slate-200" />
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Formules Essentielles</h2>
        </div>
        
        <div className="grid sm:grid-cols-2 gap-4 text-sm">
          <div className="p-4 bg-white dark:bg-slate-900/80 rounded-lg">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Espérance & Variance</h3>
          ...
          <div className="p-4 bg-white dark:bg-slate-900/80 rounded-lg">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Lois Usuelles</h3>
            <ul className="space-y-1 text-slate-700 dark:text-slate-300">
          ...
          <div className="p-4 bg-white dark:bg-slate-900/80 rounded-lg">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Inégalités</h3>
            <ul className="space-y-1 text-slate-700 dark:text-slate-300">
          ...
          <div className="p-4 bg-white dark:bg-slate-900/80 rounded-lg">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-2">VA 2D</h3>
            <ul className="space-y-1 text-slate-700 dark:text-slate-300">
