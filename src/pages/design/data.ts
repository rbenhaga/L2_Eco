...
export const COURSES: Course[] = [
    {
        key: "macro",
        title: "Macroéconomie",
        subtitle: "S3 · Mécanismes & modèles",
        progress: 65,
    ...
    },
    {
        key: "micro",
        title: "Microéconomie",
        subtitle: "S3 · Choix du consommateur",
        progress: 45,
...
export const COURSE_RESOURCES: Record<CourseKey, ResourceItem[]> = {
    ...
    socio: [
        { id: "so-c1", type: "Cours", title: "Chapitre · Sociologie classique", meta: "PDF", locked: true },
        { id: "so-q1", type: "QCM", title: "QCM · Domination", meta: "20 questions", locked: true },
    ],
};
