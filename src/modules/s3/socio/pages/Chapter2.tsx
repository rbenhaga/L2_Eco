            ...
            >
              ...
              <div className="p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-emerald-100 rounded-lg text-xs font-medium text-emerald-700">Observations</span>
                  <span className="px-3 py-1 bg-emerald-100 rounded-lg text-xs font-medium text-emerald-700">Entretiens</span>
                  <span className="px-3 py-1 bg-emerald-100 rounded-lg text-xs font-medium text-emerald-700">Statistiques</span>
                </div>
              </div>
            </AuthorCard>
