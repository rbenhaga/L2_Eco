          ...
          <div className="p-4 sm:p-6 bg-white dark:bg-slate-900/80 border border-slate-200 rounded-2xl shadow-sm">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3 p-2 bg-emerald-50/50 rounded-lg">
                <span className="w-6 h-6 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-xs font-bold">1</span>
                <p className="text-xs sm:text-sm text-slate-700"><strong>Transgression</strong> de la norme (volontaire ou non)</p>
              </div>
              <div className="flex items-center gap-3 p-2 bg-emerald-50/50 rounded-lg">
                <span className="w-6 h-6 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-xs font-bold">2</span>
                <p className="text-xs sm:text-sm text-slate-700"><strong>Apprentissage</strong> avec le groupe (répétition)</p>
              </div>
              <div className="flex items-center gap-3 p-2 bg-emerald-50/50 rounded-lg">
                <span className="w-6 h-6 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-xs font-bold">3</span>
                <p className="text-xs sm:text-sm text-slate-700"><strong>Désignation publique</strong> (étiquetage par la société)</p>
              </div>
              <div className="flex items-center gap-3 p-2 bg-emerald-50/50 rounded-lg">
                <span className="w-6 h-6 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-xs font-bold">4</span>
            ...
            >
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                  <span className="w-7 h-7 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0">1</span>
                  <div>
                ...
                <div className="flex items-start gap-3 p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                  <span className="w-7 h-7 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0">2</span>
                  <div>
                ...
                <div className="flex items-start gap-3 p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                  <span className="w-7 h-7 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0">3</span>
                  <div>
                ...
                <div className="flex items-start gap-3 p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                  <span className="w-7 h-7 bg-emerald-600 dark:bg-emerald-950/30 text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0">4</span>
                  <div>
