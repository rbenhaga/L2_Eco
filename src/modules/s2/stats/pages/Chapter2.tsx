    ...
    <main className="max-w-6xl px-6">
      ...
      <Section type="intuition" title="I. Qu'est-ce qu'une Variable Aléatoire ?">
        ...
        <div className="my-4 p-4 bg-slate-100/50 dark:bg-white/5 rounded-lg">
          ...
          />
          <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-2">Une VA transforme un événement e ∈ Ω en un réel X(e) ∈ ℝ</p>
        </div>
      ...
      <Section type="key" title="II. Loi de Probabilité">
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-slate-100/80 dark:bg-white/5">
                ...
                <th className="border border-slate-300 dark:border-white/15 p-2">0</th>
                <th className="border border-slate-300 dark:border-white/15 p-2">1</th>
                <th className="border border-slate-300 dark:border-white/15 p-2">2</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-slate-300 dark:border-white/15 p-2"><Math>{"P_x"}</Math></td>
                <td className="border border-slate-300 dark:border-white/15 p-2">1/4</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">1/2</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">1/4</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="my-4 p-4 bg-slate-100/50 dark:bg-white/5 rounded-lg">
          <img 
            ...
            className="w-full max-w-md mx-auto"
          />
          <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-2">Diagramme en bâtons : chaque bâton représente P(X = xᵢ)</p>
        </div>
      ...
      <Section type="key" title="III. Fonction de Répartition">
        ...
        <div className="my-4 p-4 bg-slate-100/50 dark:bg-white/5 rounded-lg">
          <img 
            ...
            className="w-full max-w-md mx-auto"
          />
          <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-2">Fonction de répartition F(x) : fonction en escalier de 0 à 1</p>
        </div>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li><Math>{"P(X \\geq x_0) = 1 - F(x_0)"}</Math> <span className="text-sm text-slate-600 dark:text-slate-400">(en continu uniquement)</span></li>
        </ul>
      </Section>
      ...
      <Section type="intuition" title="IV. Typologie des Variables Aléatoires">
        ...
        <div className="overflow-x-auto mb-4">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-slate-100/80 dark:bg-white/5">
                <th className="border border-slate-300 dark:border-white/15 p-2">Type</th>
                <th className="border border-slate-300 dark:border-white/15 p-2">Cardinalité de 𝒳</th>
                <th className="border border-slate-300 dark:border-white/15 p-2">Description</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-slate-300 dark:border-white/15 p-2 font-semibold">Discrète</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Fini ou infini dénombrable</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Valeurs isolées</td>
              </tr>
              <tr>
                <td className="border border-slate-300 dark:border-white/15 p-2 font-semibold">Continue</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Infini (non dénombrable)</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Intervalle ou réunion d'intervalles</td>
              </tr>
              <tr>
                <td className="border border-slate-300 dark:border-white/15 p-2 font-semibold">Mixte</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Réunion des deux</td>
                <td className="border border-slate-300 dark:border-white/15 p-2">Partie discrète + partie continue</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <Section type="formule" title="VII. Moments">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Note : <Math>{"m_1 = E(X)"}</Math></p>

        <p className="mb-2"><strong>Moment centré d'ordre k :</strong></p>
        <FormulaBox>{"\\mu_k = E[(X - E(X))^k]"}</FormulaBox>
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Note : <Math>{"\\mu_2 = V(X)"}</Math></p>
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">Utilisé pour les VA discrètes à valeurs entières (0, 1, 2, ...).</p>
