    ...
    <main className="max-w-6xl px-6">
      ...
      <Section type="key" title="Les 5 Formules Critiques">
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="p-4 bg-emerald-50 dark:bg-emerald-950/30 rounded-xl border border-emerald-200">
      ...
      <Section type="formule" title="Théorie du Consommateur">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Pente : <Math>{"-p_1/p_2"}</Math></p>

        <FormulaBox label="TMS et Condition d'Optimalité" highlight>
          {"TMS_{1,2} = \\frac{Um_{x_1}}{Um_{x_2}} = \\frac{p_1}{p_2}"}
        </FormulaBox>
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Équivalent : <Math>{"\\frac{Um_{x_1}}{p_1} = \\frac{Um_{x_2}}{p_2}"}</Math></p>
      ...
      <Section type="formule" title="Travail-Loisir">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Pente : <Math>{"-w/p"}</Math> (coût d'opportunité du loisir)</p>
      ...
      <Section type="formule" title="Choix Intertemporels">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Pente : <Math>{"-(1+r)"}</Math></p>
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">s {'>'} 0 : épargnant | s {'<'} 0 : emprunteur</p>
      </Section>
      ...
      <Section type="formule" title="Surplus et Slutsky">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Aire sous la courbe de demande moins dépense effective</p>
      ...
      <Section type="formule" title="Théorie du Producteur">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Équivalent : <Math>{"\\frac{Pm_L}{w} = \\frac{Pm_K}{r}"}</Math></p>
      ...
      <Section type="formule" title="Concurrence Pure et Parfaite">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Seuil de fermeture : P = min CVM</p>

        <FormulaBox label="Long terme" highlight>
          {"P = Cm(Q^*) = CM_{min} \\quad \\text{et} \\quad \\pi = 0"}
        </FormulaBox>
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Seuil de rentabilité : P = min CM</p>
      ...
      <Section type="formule" title="Monopole et Oligopole">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Demande linéaire P = a - bQ → Rm = a - 2bQ</p>

        <FormulaBox label="Équilibre du monopole" highlight>
          {"Rm = Cm"}
        </FormulaBox>
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-4">Puis P* = P(Q*) avec P* {'>'} Cm</p>
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">Cas linéaire (P = a - b(q₁+q₂), Cm = c) :</p>
