    ...
    return (
        ...
        >
            ...
            <div id="s3-2" className="mb-12">
                ...
                <FormulaBox highlight>{`1\\,\\\text{EUR} = 1{,}17\\,\\$`}</FormulaBox>
                ...
                <FormulaBox>{`1\\,\\$ = 0{,}86\\,\\\text{EUR}`}</FormulaBox>
            ...
            <div id="s3-3" className="mb-12">
                ...
                <FormulaBox highlight>{`E_{\\$/\\\text{EUR}} = 1{,}17`}</FormulaBox>
            ...
            <div id="s3-8" className="mb-12">
                ...
                <Section type="exemple" title="Cas pratique : PME française exportatrice de vin">
                    ...
                    <ul className="list-disc pl-5 space-y-1 mb-3">
                        ...
                        <li>Recette réelle convertie : <Math>{'1\\,000\\,\\$ \\div 1{,}50 = 666{,}67\\,\\text{EUR}'}</Math></li>
                    </ul>
                </Section>
            ...
            <div id="s3-9" className="mb-12">
                ...
                <ol className="list-decimal pl-6 space-y-3 mb-4 text-[15px]" style={{ color: 'var(--color-text-secondary)' }}>
                    <li><strong>La règle du jeu (Le Peg) :</strong> La BCE fixe un prix intangible : <Math>{'\\bar{E}_{\\$/\\\text{EUR}} = 1{,}05'}</Math> (→ 1 € = 1,05 $). Elle s'interdit de laisser le cours monter au-dessus (ou descendre en-dessous).</li>
