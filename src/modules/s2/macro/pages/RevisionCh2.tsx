  ...
  return (
    <main className="max-w-6xl px-6">
      ...
      <Section type="formule" title="Modèle WS-PS">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300">u↑ → W↓ (moins de pouvoir de négociation) | z↑ → W↑ (allocations, syndicats)</p>

        <FormulaBox label="PS (Price Setting)" highlight>
          {"\\frac{W}{P} = \\frac{1}{1 + \\mu}"}
        </FormulaBox>
        <p className="text-sm text-slate-700 dark:text-slate-300">μ = taux de marge. PS est HORIZONTALE (ne dépend pas de u)</p>
      </Section>
      ...
      <section className="mb-16">
        <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide mb-4 px-3 py-1.5 rounded-md bg-purple-50 dark:bg-purple-950/30 text-purple-700">
