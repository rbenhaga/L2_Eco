      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-1">k</th><th className="border border-slate-300 dark:border-white/15 p-1">9</th><th className="border border-slate-300 dark:border-white/15 p-1">13</th><th className="border border-slate-300 dark:border-white/15 p-1">14</th><th className="border border-slate-300 dark:border-white/15 p-1">15</th><th className="border border-slate-300 dark:border-white/15 p-1">19</th><th className="border border-slate-300 dark:border-white/15 p-1">21</th></tr></thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X=k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0324</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0956</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1024</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1024</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0557</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0299</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0699</td><td className="border border-slate-300 dark:border-white/15 p-1">0.3632</td><td className="border border-slate-300 dark:border-white/15 p-1">0.4657</td><td className="border border-slate-300 dark:border-white/15 p-1">0.5681</td><td className="border border-slate-300 dark:border-white/15 p-1">0.8752</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9469</td></tr>
            </tbody>
          </table>
          ...
          <p className="text-slate-700 dark:text-slate-300">Valeur exacte: 0.9469 - 0.0374 = 0.9095</p>
        </div>
      ),
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm">
            ...
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-2">P(X=k)</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0830</td><td className="border border-slate-300 dark:border-white/15 p-2">0.3228</td><td className="border border-slate-300 dark:border-white/15 p-2">0.3874</td><td className="border border-slate-300 dark:border-white/15 p-2">0.1761</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0293</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0014</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-2">n</th><th className="border border-slate-300 dark:border-white/15 p-2">P(X≤1)</th></tr></thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">5</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0308</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">6</td><td className="border border-slate-300 dark:border-white/15 p-2">0.0109</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2 font-semibold">7</td><td className="border border-slate-300 dark:border-white/15 p-2 text-emerald-600 font-semibold">0.0038</td></tr>
            </tbody>
          </table>
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            ...
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.6676</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9401</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9929</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9994</td></tr>
            </tbody>
          </table>
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            ...
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X=k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0067</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1404</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0653</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0181</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-1">P(X≤k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.0067</td><td className="border border-slate-300 dark:border-white/15 p-1">0.2650</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9319</td><td className="border border-slate-300 dark:border-white/15 p-1">0.9863</td></tr>
            </tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-xs">
            <thead><tr><th className="border border-slate-300 dark:border-white/15 p-1">k</th><th className="border border-slate-300 dark:border-white/15 p-1">3</th><th className="border border-slate-300 dark:border-white/15 p-1">4</th><th className="border border-slate-300 dark:border-white/15 p-1">5</th></tr></thead>
            <tbody><tr><td className="border border-slate-300 dark:border-white/15 p-1">P(Z=k)</td><td className="border border-slate-300 dark:border-white/15 p-1">0.2054</td><td className="border border-slate-300 dark:border-white/15 p-1">0.2182</td><td className="border border-slate-300 dark:border-white/15 p-1">0.1746</td></tr></tbody>
          </table>
