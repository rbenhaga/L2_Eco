    ...
    return (
        <section id="section-4" data-section-title="4. Parite de Pouvoir d'Achat (PPA)" className="mb-16">
            ...
            <div id="s4-1" className="mb-12">
                ...
                <FormulaBox label="Taux de change reel" highlight>{`\\varepsilon_{\\text{USD}/\\text{EUR}} = E_{\\text{USD}/\\text{EUR}} \\times \\frac{P}{P^*}`}</FormulaBox>
            </div>
            ...
            <div id="s4-3" className="mb-12">
                ...
                <Section type="exemple" title="Exemple vin France / USA">
                    <p className="mb-2">Donnees : <Math>{'P=20\\,\\text{EUR}'}</Math>, <Math>{'P^*=30\\,\\text{USD}'}</Math>, <Math>{'E=1{,}17\\,\\text{USD}/\\text{EUR}'}</Math>.</p>
            ...
            <div id="s4-5" className="mb-12">
                ...
                <Section type="definition" title="LPU">
                    ...
                    <FormulaBox highlight>{`E_{\\text{USD}/\\text{EUR}} \\times P = P^*`}</FormulaBox>
                </Section>
            </div>
