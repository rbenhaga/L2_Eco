                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 pointer-events-none">
                        <motion.div
                            ...
                            className="relative w-full max-w-[512px] p-8 rounded-3xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-2xl pointer-events-auto"
                        >
                            {/* Close button */}
                            <button
                                onClick={onClose}
                            ...
                            {/* Title */}
                            <h2 className="text-2xl font-bold text-center text-slate-900 dark:text-slate-50 mb-3">
                                Contenu Premium
                            </h2>
                            ...
                            <div className="space-y-3 mb-8">
                                {[
                                    ...
                                    >
                                        <div className="shrink-0 w-6 h-6 rounded-full bg-indigo-100 dark:bg-indigo-500/20 flex items-center justify-center">
