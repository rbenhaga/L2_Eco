  ...
  exercises: [
    {
      ...
      solution: (
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">On intègre sur D_{'{Y/X}'} qui dépend de x :</p>
          ...
          <div className="p-3 bg-emerald-50 dark:bg-emerald-950/30 rounded border border-emerald-200 mt-2">
            <M>{"a(x) = \\begin{cases} \\frac{5x^4}{132} & 0 \\leq x \\leq 2 \\\\ \\frac{10x}{33} & 2 < x \\leq 3 \\end{cases}"}</M>
          </div>

          <p><strong>Marginale b(y) :</strong></p>
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">On intègre sur D_{'{X/Y}'} = [y, 3] :</p>
          ...
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">Formule : <M>{"E(Y|X=x) = \\int y \\cdot b^x(y) dy"}</M></p>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-4">
          ...
          <div className="p-3 bg-emerald-50 dark:bg-emerald-950/30 rounded border border-emerald-200">
            <M>{"a(x) = \\begin{cases} ax^3 + \\frac{2x^4}{3} & 0 \\leq x \\leq 1 \\\\ ax^2 + \\frac{2x}{3} & 1 < x \\leq 2 \\end{cases}"}</M>
          </div>
          
          <p><strong>3. E(X) :</strong></p>
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">Découper aussi : <M>{"E(X) = \\int_0^1 x \\cdot a(x) dx + \\int_1^2 x \\cdot a(x) dx"}</M></p>
          <M>{"E(X) = \\boxed{1.463}"}</M>
        </div>
      ),
    },
    {
      ...
      solution: (
        <div className="space-y-4">
          ...
          <p><strong>Marginale b(y) :</strong></p>
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-2">D_{'{X/Y}'} = [y, y+4] (largeur constante = 4)</p>
