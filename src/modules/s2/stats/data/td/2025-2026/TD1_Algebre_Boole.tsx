  ...
  exercises: [
    {
      ...
      solution: (
        <div className="space-y-3">
          <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-500 p-3 mb-4">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm mb-3">
            <thead>
              <tr className="bg-slate-100/80 dark:bg-white/5">
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">Élément</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{a}'}</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{c,d}'}</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{b,d,e}'}</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">→ Atome</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1 font-semibold">a</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">✓</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 bg-yellow-50">{'{a}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1 font-semibold">b</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">✓</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 bg-green-50" rowSpan={2}>{'{b,e}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1 font-semibold">e</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">✓</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1 font-semibold">c</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">✓</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 text-center">-</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1 bg-orange-50">{'{c}'}</td></tr>
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm mb-3">
            <thead>
              <tr className="bg-slate-100/80 dark:bg-white/5">
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">Nb d'atomes</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">Combinaisons</th>
                <th className="border border-slate-300 dark:border-white/15 px-3 py-1">Éléments de F</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1">0</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">C(4,0) = 1</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">∅</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1">1</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">C(4,1) = 4</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{a}'}, {'{c}'}, {'{d}'}, {'{b,e}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1">2</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">C(4,2) = 6</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{a,c}'}, {'{a,d}'}, {'{a,b,e}'}, {'{c,d}'}, {'{c,b,e}'}, {'{d,b,e}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1">3</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">C(4,3) = 4</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">{'{a,c,d}'}, {'{a,c,b,e}'}, {'{a,d,b,e}'}, {'{c,d,b,e}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 px-3 py-1">4</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">C(4,4) = 1</td><td className="border border-slate-300 dark:border-white/15 px-3 py-1">Ω = {'{a,b,c,d,e}'}</td></tr>
            </tbody>
          </table>
          
          <p className="text-sm text-slate-700 dark:text-slate-300">Total : 1 + 4 + 6 + 4 + 1 = 16 ✓</p>
          
          <p className="mt-2"><strong>Réponse finale :</strong></p>
          <div className="bg-slate-100/50 dark:bg-white/5 p-3 rounded border overflow-x-auto">
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm mt-2">
            <thead>
              <tr><th className="border border-slate-300 dark:border-white/15 p-2">#</th><th className="border border-slate-300 dark:border-white/15 p-2">Réponse</th><th className="border border-slate-300 dark:border-white/15 p-2">Justification</th></tr>
            </thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">1</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">{'{F}'} n'existe pas car F ∉ Ω = {'{A,B,C,D,E}'}</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">2</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">{'{D}'} ∪ {'{E}'} = {'{D,E}'} ∉ F car E et C forment un atome inséparable</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">3</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">∅̄ ∩ {'{A,B}'} = Ω ∩ {'{A,B}'} = {'{A,B}'} ∈ F, donc l'affirmation est fausse</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">4</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">(Ω̄ ∩ ∅) ∪ ({'{B,C}'} ∩ {'{D,E}'}) = ∅ ∪ ∅ = ∅ ∈ F</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">5</td><td className="border border-slate-300 dark:border-white/15 p-2 text-emerald-600">VRAI</td><td className="border border-slate-300 dark:border-white/15 p-2">C apparaît dans 8/16 = 50% des éléments de F</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">6</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">B apparaît dans 8/16 = 50% (pas 75%)</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">7</td><td className="border border-slate-300 dark:border-white/15 p-2 text-red-600">FAUX</td><td className="border border-slate-300 dark:border-white/15 p-2">{'{B}'} ∩ {'{A,D}'} ∩ {'{B,C,D,E}'} = ∅ ∈ F</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">8</td><td className="border border-slate-300 dark:border-white/15 p-2 text-emerald-600">VRAI</td><td className="border border-slate-300 dark:border-white/15 p-2">Parties à 2 éléments de Ω : {'{A,B}'}, {'{A,D}'}, {'{B,D}'}, {'{C,E}'} = 4/16 = 25%</td></tr>
            </tbody>
          </table>
        </div>
      ),
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-slate-300 dark:border-white/15 text-sm">
            <thead>
              <tr><th className="border border-slate-300 dark:border-white/15 p-2"></th><th className="border border-slate-300 dark:border-white/15 p-2">Défectueuse (D)</th><th className="border border-slate-300 dark:border-white/15 p-2">Non défectueuse</th><th className="border border-slate-300 dark:border-white/15 p-2">Total</th></tr>
            </thead>
            <tbody>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">Abîmée (A)</td><td className="border border-slate-300 dark:border-white/15 p-2">30</td><td className="border border-slate-300 dark:border-white/15 p-2">20</td><td className="border border-slate-300 dark:border-white/15 p-2">50</td></tr>
              <tr><td className="border border-slate-300 dark:border-white/15 p-2">Non abîmée</td><td className="border border-slate-300 dark:border-white/15 p-2">19</td><td className="border border-slate-300 dark:border-white/15 p-2">931</td><td className="border border-slate-300 dark:border-white/15 p-2">950</td></tr>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <p className="text-sm text-slate-700 dark:text-slate-300 mb-1">B \ (A∩B) = éléments de B qui ne sont pas dans A∩B = B ∩ Ā (car A∩B est exactement la partie de B qui est dans A)</p>
