    ...
    return (
        ...
        >
            ...
            <div id="s1-1" className="mb-12">
                ...
                </p>                <Callout type="tip" title="Autarcie, en une phrase">
                    <p>
                        Une économie en autarcie vit en vase clos : pas d'importations, pas d'exportations, et pas d'emprunt au reste du monde.
                    </p>
                </Callout>
                ...
                <p className="text-[15px] leading-relaxed mb-3" style={{ color: 'var(--color-text-secondary)' }}>
                    Concrètement, cela veut dire que tout ce qui est produit doit être utilisé dans le pays. En autarcie, on ne peut ni
                    consommer davantage que la production (<Math>{'Y < C + I + G'}</Math>), ni exporter un surplus non absorbé
                    (<Math>{'Y > C + I + G'}</Math>).
                </p>
                ...
                </Callout>                <h4 className="text-lg font-medium mb-3 mt-6" style={{ color: 'var(--color-text-primary)' }}>
                    1.1.3 Décomposer l'investissement : FBCF + variation de stocks
                </h4>
                <ul className="list-disc pl-6 space-y-1 mb-4 text-[15px]" style={{ color: 'var(--color-text-secondary)' }}>
                    <li><strong>FBCF</strong> : investissements productifs (machines, bâtiments, logiciels, infrastructures).</li>
                    <li><strong>Variation de stocks</strong> : production non vendue pendant la période, comptée comme investissement en stocks.</li>
                </ul>
                <Section type="exemple" title="Exemple rapide">
                    <p className="mb-2">
                        Si <Math>{'Y = 100'}</Math>, <Math>{'C = 80'}</Math>, <Math>{'G = 0'}</Math> et <Math>{'FBCF = 0'}</Math>, alors 20 unités
                        restent invendues. Elles deviennent une hausse de stocks : <Math>{'\\Delta Stocks = 20'}</Math>.
                    </p>
                    <p className="mb-2">
                        Donc <Math>{'I = FBCF + \\Delta Stocks = 0 + 20 = 20'}</Math> et l'identité reste vraie :
                        <Math>{' Y = C + I + G = 80 + 20 + 0 = 100'}</Math>.
                    </p>
                </Section>
            </div>
            ...
            <div id="s1-4" className="mb-12">
                ...
                <Section type="exemple" title="Cas d'étude : Leprechaun Economics">
                    ...
                    <FormulaBox>{`\\text{Solde Courant reel} : +254 - 230 = +24\\,\\text{Mds EUR}`}</FormulaBox>
