    ...
    return (
        ...
        >
            ...
            <div className="space-y-3">
                ...
                <FormulaBox label="4. TCR">{`\\varepsilon = E_{\\text{USD}/\\text{EUR}} \\times \\frac{P_{FR}}{P_{US}}`}</FormulaBox>
                <FormulaBox label="5. PPA" highlight>{`E^{PPA}_{\\text{USD}/\\text{EUR}} = \\frac{P^{US}}{P^{FR}}`}</FormulaBox>
            </div>
        </section>
    );
}
