        ...
        <div className="space-y-5 sm:space-y-6">
          ...
          <div className="p-4 sm:p-6 bg-white dark:bg-slate-900/80 border border-slate-200 rounded-2xl shadow-sm">
            ...
            <blockquote className="p-3 bg-linear-to-r from-violet-50 to-transparent rounded-xl border-l-3 border-violet-400 text-sm">
              <p className="italic text-slate-700">"La sociologie est une fille des révolutions"</p>
              <p className="text-xs text-violet-600 mt-1 font-medium">— Duvignaud</p>
            </blockquote>
          </div>
          ...
          <div className="p-4 sm:p-6 bg-white dark:bg-slate-900/80 border border-slate-200 rounded-2xl shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
              <div className="p-3 sm:p-4 bg-linear-to-br from-rose-50 to-pink-50/30 rounded-xl border border-rose-100 text-center">
                <p className="font-bold text-rose-700 text-lg">1679</p>
                <p className="font-medium text-slate-900">Habeas Corpus</p>
                <p className="text-xs text-slate-500">Angleterre</p>
              </div>
              <div className="p-3 sm:p-4 bg-linear-to-br from-sky-50 to-blue-50/30 rounded-xl border border-sky-100 text-center">
                <p className="font-bold text-sky-700 text-lg">1776</p>
                <p className="font-medium text-slate-900">Indépendance</p>
                <p className="text-xs text-slate-500">USA</p>
              </div>
              <div className="p-3 sm:p-4 bg-linear-to-br from-indigo-50 to-violet-50/30 rounded-xl border border-indigo-100 text-center">
                <p className="font-bold text-indigo-700 text-lg">1789</p>
                <p className="font-medium text-slate-900">Révolution</p>
                <p className="text-xs text-slate-500">France + DDHC</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 bg-white dark:bg-slate-900/80 border border-slate-200 rounded-2xl shadow-sm">
            ...
            <div className="space-y-3 text-sm">
              <div className="p-3 sm:p-4 bg-linear-to-r from-amber-50 to-transparent rounded-xl border-l-3 border-amber-400">
                <strong className="text-amber-700">Révolution industrielle</strong>
                <p className="text-slate-600 text-xs sm:text-sm mt-1">Fin des corporations • Naissance du <strong>prolétariat</strong> • Urbanisation/exode rural • <strong>Positivisme</strong></p>
              </div>
              
              <div className="p-3 sm:p-4 bg-linear-to-r from-emerald-50 to-transparent rounded-xl border-l-3 border-emerald-400">
                <div className="flex justify-between items-start">
                  <strong className="text-emerald-700">Villermé</strong>
                  <span className="text-xs text-slate-500">Enquête ouvriers textiles</span>
                </div>
                <p className="text-slate-600 text-xs sm:text-sm mt-1">Premiers outils : <strong>observations, entretiens, statistiques</strong></p>
              </div>
              
              <div className="p-3 sm:p-4 bg-linear-to-r from-sky-50 to-transparent rounded-xl border-l-3 border-sky-400">
                <div className="flex justify-between items-start">
                  <strong className="text-sky-700">Le Play</strong>
                  <span className="text-xs text-slate-500">Ouvriers européens</span>
                </div>
                <p className="text-slate-600 text-xs sm:text-sm mt-1">Outil statistique : <strong>budgets des ouvriers</strong> • Fonde la Société d'économie sociale</p>
              </div>
              
              <div className="p-3 sm:p-4 bg-linear-to-r from-violet-50 to-transparent rounded-xl border-l-3 border-violet-400">
                <strong className="text-violet-700">Saint-Simon</strong>
                <p className="text-slate-600 text-xs sm:text-sm mt-1">Science de la société sur modèle sciences naturelles • <strong>"Physiologie sociale"</strong> • Nouveaux détenteurs du pouvoir = dirigeants économiques</p>
              </div>
              
              <div className="p-3 sm:p-4 bg-linear-to-r from-rose-50 to-transparent rounded-xl border-l-3 border-rose-400">
                <div className="flex justify-between items-start">
                  <strong className="text-rose-700">Karl Marx</strong>
                  <span className="text-xs text-slate-500">Le Capital</span>
                </div>
                <p className="text-slate-600 text-xs sm:text-sm mt-1"><strong>Conflit social</strong> : capitalistes vs prolétariat • <strong>Aliénation</strong> • Sociologie du travail • Sociologie de la connaissance</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 bg-linear-to-br from-rose-50/50 to-amber-50/30 border border-rose-100 rounded-2xl">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="p-3 bg-white/80 rounded-xl text-center">
                <p className="font-semibold text-slate-900 mb-1">Capitalistes</p>
                <p className="text-xs text-slate-600">Détiennent les <strong>moyens de production</strong></p>
              </div>
              <div className="p-3 bg-white/80 rounded-xl text-center">
                <p className="font-semibold text-slate-900 mb-1">Prolétariat</p>
                <p className="text-xs text-slate-600">Ne possèdent que leur <strong>force de travail</strong></p>
              </div>
            </div>
            <p className="text-xs text-slate-500 mt-3 text-center">→ Rapports de production génèrent des <strong>antagonismes sociaux</strong></p>
          </div>
          ...
          {/* Enjeu */}
          <div className="p-4 bg-linear-to-r from-slate-50 to-transparent rounded-xl border border-slate-200">
            <p className="text-sm text-slate-600">
              <strong className="text-slate-800">🎯 Enjeu des premiers sociologues :</strong> Recréer du <strong>lien social</strong> 
      ...
      {view === 'full' && (
        <>
          <Section title="Introduction : Contexte d'émergence">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
              <div className="p-4 bg-linear-to-br from-rose-50 to-pink-50/30 rounded-xl border border-rose-100">
                <h5 className="font-semibold text-slate-900 text-sm mb-2">Contexte de naissance</h5>
              ...
              <div className="p-4 bg-linear-to-br from-emerald-50 to-teal-50/30 rounded-xl border border-emerald-100">
                <h5 className="font-semibold text-slate-900 text-sm mb-2">Enjeu des premiers sociologues</h5>
                <ul className="text-xs sm:text-sm text-slate-600 space-y-1">
          ...
          <Section title="I. La sociologie fille des révolutions">
            <blockquote className="text-base sm:text-lg italic text-slate-600 border-l-4 border-violet-300 pl-4 mb-6">
              "La sociologie est une fille des révolutions"
              <span className="block text-sm font-medium text-violet-600 mt-1">— Duvignaud</span>
            </blockquote>
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4">
                <div className="text-center p-2.5 sm:p-4 bg-linear-to-br from-rose-50 to-pink-50/30 rounded-xl border border-rose-100">
                  <p className="font-bold text-rose-700 text-sm sm:text-base">1679</p>
                  <p className="text-xs text-slate-600">Habeas Corpus</p>
                  <p className="text-xs text-slate-500">Angleterre</p>
                </div>
                <div className="text-center p-2.5 sm:p-4 bg-linear-to-br from-sky-50 to-blue-50/30 rounded-xl border border-sky-100">
                  <p className="font-bold text-sky-700 text-sm sm:text-base">1776</p>
                  <p className="text-xs text-slate-600">Indépendance</p>
                  <p className="text-xs text-slate-500">USA</p>
                </div>
                <div className="text-center p-2.5 sm:p-4 bg-linear-to-br from-indigo-50 to-violet-50/30 rounded-xl border border-indigo-100">
                  <p className="font-bold text-indigo-700 text-sm sm:text-base">1789</p>
                  <p className="text-xs text-slate-600">Révolution</p>
                  <p className="text-xs text-slate-500">France</p>
                </div>
              </div>

              <div className="p-3 bg-linear-to-r from-rose-50/50 to-transparent rounded-xl border-l-3 border-rose-300">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div className="p-3 sm:p-4 bg-linear-to-br from-sky-50/50 to-transparent rounded-xl border border-sky-100">
                  <p className="font-semibold text-slate-900 text-sm mb-2">Transformations économiques</p>
                ...
                <div className="p-3 sm:p-4 bg-linear-to-br from-sky-50/50 to-transparent rounded-xl border border-sky-100">
                  <p className="font-semibold text-slate-900 text-sm mb-2">Conséquences sociales</p>
                  <ul className="space-y-1 text-xs sm:text-sm text-slate-600">
              ...
              <div className="p-3 sm:p-4 bg-linear-to-br from-amber-50/50 to-orange-50/30 rounded-xl border border-amber-100 mb-4">
                <p className="font-medium text-slate-900 text-sm mb-2">Progrès technique et essor de la science</p>
          ...
          <Section title="II. Les débuts des enquêtes sociologiques">
            ...
            >
              ...
              <div className="p-3 bg-linear-to-r from-emerald-50/50 to-transparent rounded-xl border border-emerald-100">
                <p className="text-xs font-semibold text-emerald-800 mb-2">Premiers outils sociologiques :</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-emerald-100 dark:bg-emerald-950/30 rounded-lg text-xs font-medium text-emerald-700">Observations</span>
                  <span className="px-3 py-1 bg-emerald-100 dark:bg-emerald-950/30 rounded-lg text-xs font-medium text-emerald-700">Entretiens</span>
                  <span className="px-3 py-1 bg-emerald-100 dark:bg-emerald-950/30 rounded-lg text-xs font-medium text-emerald-700">Statistiques</span>
                </div>
              </div>
            </AuthorCard>
          ...
          <Section title="III. Karl Marx : sociologie du conflit">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="text-center p-3 sm:p-4 bg-linear-to-br from-rose-50 to-pink-50/30 rounded-xl border border-rose-100">
                  <p className="font-bold text-rose-700">Capitalistes</p>
                  <p className="text-xs text-slate-600 mt-1">Détiennent les <strong>moyens de production</strong></p>
                  <p className="text-xs text-slate-500">Bourgeoisie</p>
                </div>
                <div className="text-center p-3 sm:p-4 bg-linear-to-br from-sky-50 to-blue-50/30 rounded-xl border border-sky-100">
                  <p className="font-bold text-sky-700">Prolétariat</p>
                  <p className="text-xs text-slate-600 mt-1">Ne possèdent que leur <strong>force de travail</strong></p>
                  <p className="text-xs text-slate-500">Classe ouvrière</p>
                </div>
              </div>

              <div className="p-3 sm:p-4 bg-linear-to-br from-slate-50 to-gray-50/30 rounded-xl border border-slate-200 mb-4">
                <p className="font-medium text-slate-900 text-sm mb-2">Contradictions du système capitaliste :</p>
                <ul className="text-xs sm:text-sm text-slate-600 space-y-1">
