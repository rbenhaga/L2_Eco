import { Section, Callout, FormulaBox, Graph, ChronologyArrow } from '../../../../../components';

/** Section 3 - Le Taux de Change (suite) */
export function Section3b() {
    return (
        <>
            <section
                id="section-3b"
                data-section-title="3. Le Taux de Change (suite)"
                className="mb-16"
            >
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    Le changement de parite
                </h3>
            ...
            <section id="s3-12" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    L'asymetrie de l'intervention dans un systeme de change fixe
                </h3>
                ...
                <h4 className="text-lg font-medium mb-3" style={{ color: 'var(--color-text-primary)' }}>
                    Contre une pression a la hausse
                </h4>
                <ul className="list-disc pl-6 space-y-1 mb-3 text-[15px]" style={{ color: 'var(--color-text-secondary)' }}>
                ...
                <h4 className="text-lg font-medium mb-3" style={{ color: 'var(--color-text-primary)' }}>
                    Contre une pression a la baisse
                </h4>
                <ul className="list-disc pl-6 space-y-1 mb-3 text-[15px]" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            <section id="s3-13" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    Illustration historique : le Mercredi Noir (1992)
                </h3>
            ...
            <section id="s3-14" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    La mecanique du gain de Soros
                </h3>
                <p className="text-[15px] leading-relaxed mb-3" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            <section id="s3-15" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    Synthese : quel ajustement a une hausse de la demande de monnaie nationale ?
                </h3>
            ...
            <section id="s3-16" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            ...
                            <tbody style={{ color: 'var(--color-text-secondary)' }}>
                                ...
                                <tr><td className="px-4 py-2.5 font-medium">Risque majeur</td><td className="px-4 py-2.5">Surreactions de marche</td><td className="px-4 py-2.5">Attaques speculatives</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <section id="s3-17" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    Le Triangle d'incompatibilite (Mundell)
                </h3>
                ...
                <Graph
                    src="/assets/s4/macro/chapter1/figure-04.png"
                    alt="Triangle d'incompatibilite de Mundell"
                    caption="Triangle de Mundell : un pays ne peut pas combiner simultanement change fixe, autonomie monetaire et libre circulation des capitaux."
                    figure={4}
                />
            </section>

            <section id="s3-18" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    Reperes historiques : l'evolution du systeme monetaire
                </h3>
                <ChronologyArrow
                    steps={[
                        { period: '1870-1914', title: 'Etalon-or', description: 'Parites fixes en or.' },
                        { period: '1918-1939', title: 'Entre-deux-guerres', description: 'Instabilite et devaluations competitives.' },
                        { period: '1944-1971', title: 'Bretton Woods', description: 'Systeme fixe centre sur le dollar.' },
                        { period: '1976', title: 'Jamaique', description: 'Officialisation des changes flottants.' },
                        { period: '1979-1999', title: 'SME puis Euro', description: 'Reponse europeenne a la volatilite.' },
                    ]}
                />
            </section>

            <section id="s3-19" className="mb-12">
                <h3 className="text-xl font-semibold mb-4" style={{ color: 'var(--color-text-primary)' }}>
                    En 2026 : le change fixe est-il de l'histoire ancienne ?
                </h3>
