        ...
        return (
            <div className="max-w-4xl mx-auto px-4 py-8 pt-20 sm:pt-28">
                <div className="mb-12 text-center sm:text-left">
                    ...
                    <h1 className="text-3xl sm:text-5xl font-bold mb-4" style={{ color: 'var(--color-text-primary)' }}>
            ...
            >
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-sm font-medium" style={{ color: 'var(--color-text-muted)' }}>
                        Score: <span className="font-bold ml-2 text-lg" style={{ color: 'var(--color-accent)' }}>{score}%</span>
                    </div>
                </div>
