      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            ...
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.0060</td><td className="border border-[var(--color-border-strong)] p-1">0.0464</td><td className="border border-[var(--color-border-strong)] p-1">0.1673</td><td className="border border-[var(--color-border-strong)] p-1">0.3823</td></tr></tbody>
          </table>
          ...
          <p className="text-[var(--color-success)] font-semibold"><M>{"\\boxed{n \\geq 5 \\text{ tirs}}"}</M></p>
        </div>
      ),
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            <thead><tr><th className="border border-[var(--color-border-strong)] p-1">k</th><th className="border border-[var(--color-border-strong)] p-1">12</th><th className="border border-[var(--color-border-strong)] p-1">14</th><th className="border border-[var(--color-border-strong)] p-1">16</th><th className="border border-[var(--color-border-strong)] p-1">18</th></tr></thead>
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.1931</td><td className="border border-[var(--color-border-strong)] p-1">0.3675</td><td className="border border-[var(--color-border-strong)] p-1">0.5660</td><td className="border border-[var(--color-border-strong)] p-1">0.7423</td></tr></tbody>
          </table>
          ...
          <M>{"P(X \\leq 16) = 0.5660 \\neq 0.3675"}</M>
          <p className="text-[var(--color-error)]">⚠️ 36.75% correspond à P(X ≤ 14), pas P(X ≤ 16)!</p>
          ...
          <p className="text-[var(--color-text-secondary)]">Valeur exacte: 0.9108 - 0.0774 = 0.8334</p>
        </div>
      ),
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-sm">
            ...
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-2">P(X=k)</td><td className="border border-[var(--color-border-strong)] p-2">0.2637</td><td className="border border-[var(--color-border-strong)] p-2">0.4945</td><td className="border border-[var(--color-border-strong)] p-2">0.2198</td><td className="border border-[var(--color-border-strong)] p-2">0.0220</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            <thead><tr><th className="border border-[var(--color-border-strong)] p-1">k</th><th className="border border-[var(--color-border-strong)] p-1">7</th><th className="border border-[var(--color-border-strong)] p-1">14</th><th className="border border-[var(--color-border-strong)] p-1">18</th></tr></thead>
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.0180</td><td className="border border-[var(--color-border-strong)] p-1">0.4657</td><td className="border border-[var(--color-border-strong)] p-1">0.8195</td></tr></tbody>
          </table>
          ...
          <p className="text-[var(--color-text-secondary)]">Valeur exacte: 0.8195 - 0.1848 = 0.6347</p>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            <thead><tr><th className="border border-[var(--color-border-strong)] p-1">k</th><th className="border border-[var(--color-border-strong)] p-1">0</th><th className="border border-[var(--color-border-strong)] p-1">1</th><th className="border border-[var(--color-border-strong)] p-1">3</th><th className="border border-[var(--color-border-strong)] p-1">6</th></tr></thead>
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.1516</td><td className="border border-[var(--color-border-strong)] p-1">0.4514</td><td className="border border-[var(--color-border-strong)] p-1">0.9004</td><td className="border border-[var(--color-border-strong)] p-1">0.9984</td></tr></tbody>
          </table>
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            <thead><tr><th className="border border-[var(--color-border-strong)] p-1">k</th><th className="border border-[var(--color-border-strong)] p-1">1</th><th className="border border-[var(--color-border-strong)] p-1">8</th><th className="border border-[var(--color-border-strong)] p-1">9</th><th className="border border-[var(--color-border-strong)] p-1">11</th></tr></thead>
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.0012</td><td className="border border-[var(--color-border-strong)] p-1">0.4557</td><td className="border border-[var(--color-border-strong)] p-1">0.5874</td><td className="border border-[var(--color-border-strong)] p-1">0.8030</td></tr></tbody>
          </table>
    ...
    },
    {
      ...
      solution: (
        <div className="space-y-3">
          ...
          <table className="border-collapse border border-[var(--color-border-strong)] text-xs">
            <thead><tr><th className="border border-[var(--color-border-strong)] p-1">k</th><th className="border border-[var(--color-border-strong)] p-1">1</th><th className="border border-[var(--color-border-strong)] p-1">4</th><th className="border border-[var(--color-border-strong)] p-1">14</th></tr></thead>
            <tbody><tr><td className="border border-[var(--color-border-strong)] p-1">P(X≤k)</td><td className="border border-[var(--color-border-strong)] p-1">0.0005</td><td className="border border-[var(--color-border-strong)] p-1">0.0293</td><td className="border border-[var(--color-border-strong)] p-1">0.9165</td></tr></tbody>
          </table>
          ...
          <p className="text-[var(--color-success)] font-semibold"><M>{"\\boxed{a = 6, \\quad b = 14}"}</M></p>
        </div>
      ),
    },
  ],
