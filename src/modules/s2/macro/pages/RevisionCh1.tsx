  ...
  return (
    <main className="max-w-6xl px-6">
      ...
      <Section type="key" title="PIB nominal, réel et déflateur">
        ...
        <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">Le déflateur mesure l'inflation. PIB réel = prix constants (pas courants !)</p>
      </Section>
      ...
      <Section type="key" title="Classiques vs Keynésiens">
        ...
        <p className="mt-2 text-sm text-slate-700 dark:text-slate-300">Synthèse moderne : Keynésiens à CT, Classiques à MT/LT</p>
      </Section>
      ...
      <Section type="formule" title="Formules IS-LM">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300">où <Math>{"c_1"}</Math> = propension marginale à consommer</p>
      </Section>
