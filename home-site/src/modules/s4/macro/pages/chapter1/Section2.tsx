        ...
        >
            ...
            <div id="s2-1" className="mb-12">
                ...
                <p className="text-[15px] leading-relaxed mb-3" style={{ color: 'var(--color-text-secondary)' }}>
                    <strong>Règle générale :</strong> Un agent est considéré comme résident s'il a une présence ou une intention de rester supérieure à 1 an.
                                ...
                                <CourseTable>
                    <CourseTableHead>
                        <CourseTableRow tone="muted">
                            <CourseTableCell header weight="semibold">Situation</CourseTableCell>
                            <CourseTableCell header align="center" weight="semibold">Résident ?</CourseTableCell>
                            <CourseTableCell header weight="semibold">Explication</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableHead>
                    <CourseTableBody>
                        <CourseTableRow>
                            <CourseTableCell>Filiale Google à Paris</CourseTableCell>
                            <CourseTableCell align="center" weight="bold" tone="key">OUI</CourseTableCell>
                            <CourseTableCell tone="muted">Activité sur le territoire</CourseTableCell>
                        </CourseTableRow>
                        <CourseTableRow tone="muted">
                            <CourseTableCell>Touriste américain (2 mois)</CourseTableCell>
                            <CourseTableCell align="center" weight="bold" tone="warning">NON</CourseTableCell>
                            <CourseTableCell tone="muted">Séjour &lt; 1 an</CourseTableCell>
                        </CourseTableRow>
                        <CourseTableRow>
                            <CourseTableCell>Étudiant étranger (Master)</CourseTableCell>
                            <CourseTableCell align="center" weight="bold" tone="key">OUI</CourseTableCell>
                            <CourseTableCell tone="muted">Présence durable (&gt; 1 an)</CourseTableCell>
                        </CourseTableRow>
                        <CourseTableRow tone="muted">
                            <CourseTableCell>Frontalier (Vit en Belgique)</CourseTableCell>
                            <CourseTableCell align="center" weight="bold" tone="warning">NON</CourseTableCell>
                            <CourseTableCell tone="muted">Centre d'intérêt = Domicile</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableBody>
                </CourseTable>
            ...
            <div id="s2-2" className="mb-12">
                ...
                <CourseTable>
                    <CourseTableHead>
                        <CourseTableRow tone="muted">
                            <CourseTableCell header weight="semibold">Poste</CourseTableCell>
                            <CourseTableCell header weight="semibold">Seuil</CourseTableCell>
                            <CourseTableCell header weight="semibold">Logique</CourseTableCell>
                            <CourseTableCell header weight="semibold">Exemple</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableHead>
                    <CourseTableBody>
                        <CourseTableRow>
                            <CourseTableCell weight="medium">IDE</CourseTableCell>
                            <CourseTableCell tone="muted">&gt; 10% du capital</CourseTableCell>
                            <CourseTableCell tone="muted">Industrielle (Contrôle, filiales, long terme)</CourseTableCell>
                            <CourseTableCell tone="muted">Renault ouvre une usine en Chine</CourseTableCell>
                        </CourseTableRow>
                        <CourseTableRow tone="muted">
                            <CourseTableCell weight="medium">Portefeuille</CourseTableCell>
                            <CourseTableCell tone="muted">Actions &lt; 10% ou Obligations</CourseTableCell>
                            <CourseTableCell tone="muted">Financière (Rendement pur, arbitrage)</CourseTableCell>
                            <CourseTableCell tone="muted">Un Français achète des actions Apple</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableBody>
                </CourseTable>
                <p className="text-[15px] leading-relaxed mb-4" style={{ color: 'var(--color-text-secondary)' }}>
            ...
            <div id="s2-3" className="mb-12">
                ...
                <CourseTable>
                    <CourseTableHead>
                        <CourseTableRow tone="muted">
                            <CourseTableCell header weight="semibold">Opération (Vue de la France)</CourseTableCell>
                            <CourseTableCell header align="right" weight="semibold">Débit (−)</CourseTableCell>
                            <CourseTableCell header align="right" weight="semibold">Crédit (+)</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableHead>
                    <CourseTableBody>
                        <CourseTableRow>
                            <CourseTableCell tone="muted">Compte Courant (Import Marchandise)</CourseTableCell>
                            <CourseTableCell align="right" weight="medium" tone="warning">30 000 €</CourseTableCell>
                            <CourseTableCell align="right" tone="muted">—</CourseTableCell>
                        </CourseTableRow>
                        <CourseTableRow tone="muted">
                            <CourseTableCell tone="muted">Compte Financier (Baisse des Avoirs)</CourseTableCell>
                            <CourseTableCell align="right" tone="muted">—</CourseTableCell>
                            <CourseTableCell align="right" weight="medium" tone="key">30 000 €</CourseTableCell>
                        </CourseTableRow>
                    </CourseTableBody>
                </CourseTable>
            </div>
